...
def get_historical(company):
    ...
    try:
        ...
        raise ValueError(f"Company '{company}' not found. Please try again.")
...
def insertintotable(request):
  if request.method == 'POST':
    ...
    # Assuming you want to add a new column 'Code' with company code 'nm'
    df['Code'] = nm

    # No need for pd.concat here if you just added a new column
